...
public:
	...
	// Constructor
	Fraction(int integer, int numerator, int denominator) : integer{ integer }, numerator{ numerator }, denominator{ this->denominator = denominator }
	{
	...
	Fraction(int integer) : Fraction { integer, 0, 1 }
	{
		cout << "SingleArgumentConstructor:\t\t" << this << endl;
		//system("pause");
	}
	Fraction(int numerator, int denominator) : Fraction { 0, numerator, this->denominator = denominator }
	{
